...
export default function Cruiser({ isDragging, color, position,onDrop, stateCouleur }) {
    ...
    function fabriqueCruiser(position) {
        return (<BoatSquare value={boatSquares[position]} click={() => onClickBoat(position)}/>);
    }

    return(
        <div className="boat">
            <div className="cruiser" ref={dragRef} style={{ opacity, backgroundColor:color}}>
